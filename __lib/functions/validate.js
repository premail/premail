...
function checkType (type, value, location, subject, opt) {
  if (typeof value === 'object' && value.constructor === Object) {
    iterate(type, value, location, subject, opt)
  } else {
    scan(type, value, location, subject, opt)
  }
}
...
function iterate (type, value, location, subject, opt) {
  for (var k in value) {
    if (typeof value[k] === 'object' && value[k] !== null) {
      iterate(type, value[k], location, subject, opt)
    } else if (typeof value[k] === 'boolean') {
      iterate(type, value[k], location, subject, opt)
    } else if (typeof value[k] === 'number') {
      value[k] = value[k] + ''
      scan(type, value[k], location, subject, opt)
    } else {
      scan(type, value[k], location, subject, opt)
    }
  }
...
function scan (type, value, location, subject, opt) {
  if (value !== null) {
