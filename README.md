...
3. Open your project folder in Sublime Text 3.
   i. Sublime should auto-detect the build-system based on your files, but you can
  check by going to Tools > Build System > MJML
   ii. Also be sure that in the Tools menu, "Save All on Build" is checked
  (default).
   iii. Edit the `.mjml` files in your email project directory.
   iv. At any time, press Ctrl-B to render `index.html`.
